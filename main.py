...
logging.info(f"============Data Transformation stage starts=============")
data_transformation_pipe = DataTransformationPipeline()
data_transformation_pipe.main()
logging.info(f"Data Transformation is Done Successfully")
